...
p=argparse.ArgumentParser();p.add_argument('--ide',required=True);p.add_argument('--plugins');p.add_argument('--license-file');p.add_argument('--languages',required=True);p.add_argument('--reports',required=True);a=p.parse_args()
